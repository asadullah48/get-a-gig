  ...
  const teamMembers = [
    {
      ...
      bio: "Asadullah is a former design architect who transitioned into software engineering, applying his creativity and problem-solving skills to the tech industry. With a background in architecture, he brings a unique perspective to building innovative digital solutions.",
